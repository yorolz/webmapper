...
function createHelpBar ()
{
	...
	box.style("position", "absolute")
		...
		.style("display", "block")
		.style("padding", "5px")
		.style("border", "solid 1px #888" /*"solid 1px white"*/)
		.style("opacity", "0.0")
		.style("background-color", "white" /*"#ddd"*/)
		.style("text-align", "left")
		.style("font-size", "12px")
		.html("<b>Webmapper v.1.0</b><br/><br/>Ryan Hamerly, Scott Chung, Sheta Chatterjee and Milinda Lakkam<br/>Learn more about Webmapper at <a href=\"" + homepage + "\" target=\"_blank\">our GitHub site &raquo;</a>")
		.transition().duration(200)
		.style("opacity", "1.00");
